...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'who.processors.compress_settings',
            ],
        },
    },
]
...
CELERY_IMPORTS = (
    'molo.core.tasks', 'google_analytics.tasks')
...
SITE_NAME = environ.get('SITE_NAME', "who")
...
FACEBOOK_PIXEL = '353235115913605'
