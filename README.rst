...
$ ./manage.py celery worker -A who -l INFO
$ ./manage.py celerybeat -A who -l INFO
...
`whoMoloGoogleAnalyticsMiddleware`
...
=================================
    ...
    `./who/settings/base.py`, `./who/settings/dev.py`, `./who/settings/docker.py` and `./who/settings/production.py`
